 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'W38N41f1');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/mtkocak/luzdemia.git');
 ...
 */
define('TARGET_DIR', '/var/www/vhosts/luzdemia.com/httpdocs/');
