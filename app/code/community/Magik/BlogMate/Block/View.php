<?php   
class Magik_BlogMate_Block_View extends Mage_Core_Block_Template{   

	public function __construct() { 
		$storeId=Mage::app()->getStore()->getStoreId();
		parent::__construct();
		
		$category_slug = $this->getRequest()->getParam('c');
		$category_id = Mage::getModel('blogmate/category')->getCategoryIdBySlug($category_slug);
	...
	public function getRecentPost($limit){
		return $recent_post = Mage::getModel('blogmate/blog')->getRecentPost($limit);
	}
