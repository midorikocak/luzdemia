    ...
    protected function insertTotals($page, $source){
        ...
        foreach ($totals as $total) {
			...
			$newkk = number_format(($kk/1.18),2,",",",") . " TL";
                    ...
                    //$newkk = number_format(($kk*18/100),2,",",",") . " TL";
                    $newkk = number_format((($kk/1.18)*18/100),2,",",",") . " TL";
                    $lineBlock['lines'][] = array(
                        array(
                            'text'      => "KDV 18",
                            'feed'      => 275,
