...
class Magik_Deziresettings_Block_Adminhtml_System_Config_Form_Field_Width extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _optionToHtml($element, $option, $selected)
    {
        ...
        $html .= '<img src="'.Mage::getDesign()->getSkinUrl('images/magik/dezire/appearance_width_'.$option['value'].'.jpg').'" alt="" /><br/>';
